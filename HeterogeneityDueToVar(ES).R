...
pb = txtProgressBar(min = 0, max = length(group.vars), initial = 0, style=3) 
for(i in 1:length(group.vars)){
  X <- SimStudies2groups(k.studies=100, meandiff=1, intercept=2, sd.meandiff=1, mean.groupsd=sqrt(group.vars[i]), sd.groupsd=.00000001, n.max=125, n.min=20)
...
pb = txtProgressBar(min = 0, max = length(group.vars), initial = 0, style=3) 
for(i in 1:length(group.vars)){
  X <- SimStudies2groups(k.studies=100, meandiff=1, intercept=2, sd.meandiff=.05, mean.groupsd=sqrt(group.vars[i]), sd.groupsd=.00000001, n.max=125, n.min=20)
...
pb = txtProgressBar(min = 0, max = length(group.vars), initial = 0, style=3) 
for(i in 1:length(group.vars)){
  X <- SimStudies2groups(k.studies=100, meandiff=1, intercept=2, sd.meandiff=.2, mean.groupsd=sqrt(group.vars[i]), sd.groupsd=.00000001, n.max=125, n.min=20)
